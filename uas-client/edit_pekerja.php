        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Edit Form Pendaftaran</h1>
                    <!-- AWAL KONTAINER -->
                    <div class="container">
                        <!-- AWAL ROW -->
                        <div class="row1">
                            <div class="col-md-9 mx-auto">
                                ...
                                <div class="card">
                                    <div class="card-header bg-warning text-center ">
                                        FORM EDIT PENDAFTARAN CALON KARYAWAN
                                    </div>
                                    <div class="card-body">
                                        <!-- AWAL FORM -->
                                        <?php
                                        $r = $pekerja->tampil_data($_GET['id_pekerja'])
                                        ?>
                                        <form method="POST" action="proses_pekerja.php">
                                            <input type="hidden" name="aksi" value="ubah" />
                                            <input type="hidden" name="id_pekerja" value="<?= $r->id_pekerja ?>" />
                                            <div class="mb-3">
                                                <label class="form-label">ID Pekerja</label>
                                                <input type="text" name=id_pekerja class="form-control" value="<?= $r->id_pekerja ?>" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Nama Pekerja</label>
                                                <input type="text" name=nama_pekerja class="form-control" placeholder="Masukkan Nama Anda" value="<?= $r->nama_pekerja ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Posisi Pekerja</label>
                                                <input type="text" name=posisi_pekerja class="form-control" placeholder="Masukkan Posisi Pekerja" value="<?= $r->posisi_pekerja ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Gaji Pekerja</label>
                                                <input type="number" name=gaji_pekerja class="form-control" placeholder="Masukkan Gaji Pekerja" value="<?= $r->gaji_pekerja ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">alamat_pekerja</label>
                                                <input type="text" name=alamat_pekerja class="form-control" placeholder="Masukan alamat Anda" value="<?= $r->alamat_pekerja ?>">
                                            </div>
                                            <div class="text-center">
                                                <hr>
                                                <button class="btn btn-warning" name="btnUbah" type="submit">Edit</button>
                                            </div>
                                        </form>
                                    </div>
