            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form method="post" action="">
                        <h1>Data Tugas Pekerja</h1>
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>ID Tugas Pekerja</th>
                                    <th>ID Tugas </th>
                                    <th>ID Pekerja</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                $no = 1;
                                $data_array = $abc->tampil_semua_tugas_pekerja();
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-danger" href="proses_tugas_pekerja.php?aksi=hapus&id_tugas_pekerja=<?= $r->id_tugas_pekerja ?>" onclick="return confirm('Apakah Anda ingin menghapus data ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
