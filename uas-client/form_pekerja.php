        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Form Pekerja</h1>
                    <!-- AWAL KONTAINER -->
                    <div class="container">
                        <!-- AWAL ROW -->
                        <div class="row1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="proses_pekerja.php">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="id_pekerja" class="form-control" placeholder="Buat ID Pekerja Anda ex: user12">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Nama Lengkap</label>
                                                <input type="text" name="nama_pekerja" class="form-control" placeholder="Masukkan Nama Anda">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Posisi Pekerja</label>
                                                <input type="text" name="posisi_pekerja" class="form-control" placeholder="Masukkan Posisi ">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Gaji Pekerja</label>
                                                <input type="number" name="gaji_pekerja" class="form-control" placeholder="Masukkan Gaji Pekerja">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Alamat Pekerja</label>
                                                <input type="text" name="alamat_pekerja" class="form-control" placeholder="Masukkan Alamat Pekerja">
                                            </div>
