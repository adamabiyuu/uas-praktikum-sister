                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $data_array = $pekerja->tampil_semua_data();
                                    foreach ($data_array as $r) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-warning"
                                                    href="edit_pekerja.php?id_pekerja=<?= $r->id_pekerja ?>">Ubah</a></td>
                                            <td><a class="btn btn-danger"
                                                    href="proses_pekerja.php?aksi=hapus&id_pekerja=<?= $r->id_pekerja ?>"
