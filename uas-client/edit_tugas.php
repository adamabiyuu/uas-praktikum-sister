                                    ...
                                    <div class="col-md-9 mx-auto">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <!-- AWAL FORM -->
                                                <?php
                                                $r = $tugas->tampil_tugas($_GET['id_tugas']);
                                                ?>
                                                <form name="form" method="POST" action="proses_tugas.php">
                                                    <input type="hidden" name="aksi" value="ubah" />
                                                    <input type="hidden" name="id_tugas" value="<?= $r->id_tugas ?>" />
                                                    <div class="mb-3">
                                                        <label class="form-label">ID Tugas</label>
                                                        <input type="text" class="form-control" value="<?= $r->id_tugas ?>" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                    <label class="form-label">ID Proyek</label>
                                                        <input type="text" name="id_proyek" class="form-control" value="<?= $r->id_proyek ?>" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Deskripsi tugas</label>
                                                        <input type="text" name="deskripsi_tugas" class="form-control" placeholder="Masukkan Deskripsi Tugas Anda" value="<?= $r->deskripsi_tugas ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Tanggal Mulai Tugas</label>
                                                        <input type="date" name="tanggal_mulai_tugas" class="form-control" value="<?= $r->tanggal_mulai_tugas ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Tanggal Selesai Tugas</label>
                                                        <input type="date" name="tanggal_selesai_tugas" class="form-control" value="<?= $r->tanggal_selesai_tugas ?>">
                                                    </div>
                                                    <label class="form-label">Status Tugas</label>
                                                        <select class="form-select" name="status_tugas" >
                                                            <option selected value="<?= $r->tanggal_selesai_tugas ?>">-Pilih-</option>
