        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Form Tugas</h1>
                    <!-- AWAL KONTAINER -->
                    <div class="container">
                        <!-- AWAL ROW -->
                        <div class="row1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="proses_tugas.php">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name=id_tugas class="form-control" placeholder="Masukkan ID ex: J01">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Deskripsi Tugas</label>
                                                <input type="text" name=deskripsi_tugas class="form-control" placeholder="Masukkan Username Anda">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name=tanggal_selesai_tugas class="form-control">
                                            </div>
                                            <div class='mb-3'>
                                            ...
                                            <!-- <div class="mb-3">
                                                ...
                                                <select class="form-select" name="id_proyek">
