        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Form Pendaftaran</h1>
                    <!-- AWAL KONTAINER -->
                    <div class="container">
                        <!-- AWAL ROW -->
                        <div class="row1">
                            <div class="col-md-9 mx-auto">
                                ...
                                <div class="card">
                                    <div class="card-header bg-info text-center ">
                                        FORM INPUT TUGAS PEKERJA
                                    </div>
                                    <div class="card-body">
                                        <!-- AWAL FORM -->
                                        <form method="POST" action="proses_tugas_pekerja.php">
                                            <input type="hidden" name="aksi" value="tambah" />
                                            <div class="mb-3">
                                                <label class="form-label">ID Tugas Pekerja</label>
                                                <input type="text" name=id_tugas_pekerja class="form-control" placeholder="Masukkan ID ex: B01">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Nama Pekerja</label>
                                                <select class="form-select" name="id_pekerja">
                                                    <option selected>-Pilih Nama Pekerja-</option>
                                                    <?php
                                                    // Include the client_proyek.php file
                                                    include "client_pekerja.php";

                                                    // Create a new Client object
                                                    $pekerjaClient = new Client($url);

                                                    // Fetch the list of proyek
                                                    $pekerjaList = $pekerjaClient->tampil_semua_data();

                                                    // Populate the dropdown with proyek data
                                                    foreach ($pekerjaList as $pekerja) {
                                                        echo "<option value='{$pekerja->id_pekerja}'>{$pekerja->nama_pekerja}</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="id_tugas">
                                                    ...
                                                    // Create a new Client object
                                                    $tugasClient = new Client($url);

                                                    // Fetch the list of proyek
                                                    $tugasList = $tugasClient->tampil_semua_tugas();

                                                    // Populate the dropdown with proyek data
                                                    foreach ($tugasList as $tugas) {
                                                        echo "<option value='{$tugas->id_tugas}'>{$tugas->deskripsi_tugas}</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
