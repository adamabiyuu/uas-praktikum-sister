                    ...
                    <form method="post" action="">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $data_array = $tugas->tampil_semua_tugas();
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $r->tanggal_mulai_tugas ?>
                                        </td>
                                        <td>
                                            <?= $r->tanggal_selesai_tugas ?>
                                        </td>
                                        <td>
                                            <?= $r->status_tugas ?>
                                        </td>
                                        <td><a class="btn btn-warning" href="edit_tugas.php?id_tugas=<?= $r->id_tugas ?>">Ubah</a>
                                        </td>
                                        <td><a class="btn btn-danger" href="proses_tugas.php?aksi=hapus&id_tugas=<?= $r->id_tugas ?>" onclick="return confirm('Apakah Anda ingin menghapus data ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
