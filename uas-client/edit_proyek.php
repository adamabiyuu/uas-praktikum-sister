                            ...
                            <div class="col-md-9 mx-auto">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!-- AWAL FORM -->
                                        <?php
                                        $r = $proyek->tampil_proyek($_GET['id_proyek']);
                                        ?>
                                        <form name="form" method="POST" action="proses_proyek.php">
                                            <input type="hidden" name="aksi" value="ubah" />
                                            <input type="hidden" name="id_proyek" value="<?= $r->id_proyek ?>" />
                                            <div class="mb-3">
                                                <label class="form-label">ID Proyek</label>
                                                <input type="text" class="form-control" value="<?= $r->id_proyek ?>" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Proyek</label>
                                                <input type="text" name="nama_proyek" class="form-control" placeholder="Deskripsikan Proyekn Anda" value="<?= $r->nama_proyek ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Tanggal Mulai</label>
                                                <input type="date" name="tanggal_mulai" class="form-control" placeholder="Masukkan Tahun" value="<?= $r->tanggal_mulai ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Tanggal Selesai</label>
                                                <input type="date" name="tanggal_selesai" class="form-control" placeholder="Masukkan Tahun" value="<?= $r->tanggal_selesai ?>">
                                            </div>
                                            <div class='mb-3'>
